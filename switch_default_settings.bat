...
copy /b/v/y "%cd%\settings\ClientConfiguration_default.xml" "%USERPROFILE%\Documents\BnS\NCWEST\ClientConfiguration.xml"
...
copy /b/v/y "%cd%\settings\binloader_default.ini" "%AppPath%\plugins\binloader.ini"
